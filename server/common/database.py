...
def is_phone_number_registered(phone_number: str) -> bool:
    ...
    :param phone_number: String phone number. Includes country code (e.g. +1 for US) and no dashes.
...
def register_phone_number(phone_number: str) -> None:
    """
    Register a phone number to be used by the app. This is essentially giving the app permission to
    send messages to this number, so this function should only be called after users give adequate
