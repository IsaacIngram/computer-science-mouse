...
def lambda_handler(event, context):
    ...
    for trap_id in event['traps']:
        ...
        old_trap_data = db.get_trap_data_by_id(trap_id)
        ...
        if old_trap_data is not None:
            ...
            db.update_trap(trap_id, hammer_status=hammer_down, battery_percent=battery_level)
        else:
    ...
    for phone_numbers, message in messages_to_send:
        ...
        for phone_number in phone_numbers:
            ...
            ms.send_sms(phone_number, message)
    return {
        'statusCode': 200,
        'body': ''
    }
